  ...
  return (
    <section className="min-h-screen bg-[#FDFCFB] flex flex-col p-4 md:p-8 relative">
      <div className="max-w-5xl mx-auto w-full">
        ...
        >
          <div className="md:col-span-5 relative md:sticky top-24">
          ...
          <div className="md:col-span-7 space-y-8 text-[#4D4741]">
            <div className="text-center md:text-left">
              <span className="text-gold text-sm sm:text-base md:text-lg font-bold tracking-[0.15em] sm:tracking-[0.3em] uppercase block mb-6 md:mb-8">
                Chuyên gia phụ trách vận hành
              </span>
              <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl text-[#1F1A17] font-bold mb-6 leading-tight">
                BS. TRẦN THUỲ DƯƠNG
              </h2>
            ...
            <div className="grid grid-cols-1 gap-6 pt-4">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-3 md:gap-4">
                ...
                <div className="w-full">
                  <h4 className="font-bold text-[#1F1A17] mb-3 md:mb-2 text-base md:text-lg text-center md:text-left">
